  ...
  love: {
    ...
    message: `${authorName} wrote you a love letter`
  },

  angry: {
    title: "🔥 New Angry Letter",
    message: `${authorName} shared an angry letter`
  },

  apologies: {
    title: "🌧 New Apology Letter",
    message: `${authorName} wrote you an apology letter`
  },

  "dream-journal": {
    title: "🌙 New Dream Journal Entry",
    message: `${authorName} added a dream journal entry`
  },

  confessions: {
    title: "🤍 New Confession",
    message: `${authorName} left you a confession`
  }
...
const notification =
  notificationMap[
    category as keyof typeof notificationMap
  ];
