...
function KissCounter({
    ...
    const sendKiss = async () => {
        ...
        return (
                                ...
                                <div ref={setContainerRef} className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50">
                        ...
                        <motion.div
                            ...
                            exit={{
                                ...
                                scale: 0.2
                                                        ...
                                                        className={
                                                            `absolute bottom-24 z-50 rounded-3xl border border-purple-300/30 bg-black/80 p-6 text-white backdrop-blur-xl
            ...
            <motion.button
                ...
                transition={{
                    ...
                    repeat: Infinity
                                ...
                                className="cursor-pointer flex h-12 w-12 md:h-16 md:w-16 flex-col items-center justify-center rounded-full border border-pink-300/40 bg-black/40 text-white backdrop-blur-xl"
